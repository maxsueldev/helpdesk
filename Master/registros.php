...
<html lang="pt-br">
    ...
    <body>
      ...
      <div class="tgeral" id="t01cad"><br/>Registros de chamados</div><br/>
      ...
      <form class="form-signin" role="form" action="#list01" method="get" autocomplete="off">
                ...
                <div class="form-group" id="inputcenter"> 
                    <input class="form-control" list="status" name="status" placeholder="Status">
                      <datalist id="status">
                        <option value="Aberto">
    ...
    <div id="list01">
      ...
      $vChamados = $chamadoDAO->selecionar($id, $setor, $relacionado, $data, $status);
      ...
      ?>
          <tr>
            ...
            <div id="btn-alter">
            <td><a href="alterChamado.php?c=<?= $chamado->getId() ?>" class="btn btn-primary"><span class="glyphicon glyphicon-cog"></span> Editar</a></td>
            </div>
          </tr>
      <?php
        }
